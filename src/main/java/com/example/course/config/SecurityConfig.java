...
import com.example.course.handler.UserAuthenticationFailureHandler;
import com.example.course.handler.UserAuthenticationSuccessHandler;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    UserAuthenticationSuccessHandler getSuccessHandler() {
        return new UserAuthenticationSuccessHandler(historyRepository, memberService);
    }
